...
using Disruptor.Benchmarks.Processing;
...
/// </summary>
public class OneToOneSequencedThroughputTest__Ref1 : IThroughputTest
{
    ...
    public OneToOneSequencedThroughputTest__Ref1()
    {
        ...
        _eventProcessor = EventProcessorRef1.Create(_ringBuffer, sequenceBarrier, _eventHandler);
