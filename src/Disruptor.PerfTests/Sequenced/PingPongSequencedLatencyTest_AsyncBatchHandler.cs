...
public class PingPongSequencedLatencyTest_AsyncBatchHandler : ILatencyTest
{
    ...
    private readonly IAsyncEventProcessor<PerfEvent> _pingProcessor;

    private readonly IAsyncSequenceBarrier _pingBarrier;
    private readonly Ponger _ponger;
    private readonly IAsyncEventProcessor<PerfEvent> _pongProcessor;

    public PingPongSequencedLatencyTest_AsyncBatchHandler()
    {
        _pingBuffer = RingBuffer<PerfEvent>.CreateSingleProducer(PerfEvent.EventFactory, _bufferSize, new AsyncWaitStrategy());
        _pongBuffer = RingBuffer<PerfEvent>.CreateSingleProducer(PerfEvent.EventFactory, _bufferSize, new AsyncWaitStrategy());
    ...
    private class Pinger : IAsyncBatchEventHandler<PerfEvent>
    {
    ...
    private class Ponger : IAsyncBatchEventHandler<PerfEvent>
    {
        private readonly RingBuffer<PerfEvent> _buffer;
        private CountdownEvent _globalSignal;
