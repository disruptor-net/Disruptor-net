...
/// </summary>
public class OneToOneSequencedThroughputTest_AsyncBatchHandler_Timeout : IThroughputTest
{
    private const int _bufferSize = 1024 * 64;
    private const long _iterations = 1000L * 1000L * 100;
    ...
    public OneToOneSequencedThroughputTest_AsyncBatchHandler_Timeout()
    {
        _eventHandler = new AdditionAsyncBatchEventHandler();
        _ringBuffer = RingBuffer<PerfEvent>.CreateSingleProducer(PerfEvent.EventFactory, _bufferSize, new TimeoutAsyncWaitStrategy(TimeSpan.FromMilliseconds(10)));
