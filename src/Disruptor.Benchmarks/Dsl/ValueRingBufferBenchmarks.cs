...
namespace Disruptor.Benchmarks.Dsl;

//[DisassemblyDiagnoser]
public class ValueRingBufferBenchmarks
{
    private readonly ValueRingBuffer<Event> _ringBuffer;

    public ValueRingBufferBenchmarks()
    {
        _ringBuffer = new ValueRingBuffer<Event>(new SingleProducerSequencer(4096, new BusySpinWaitStrategy()));
    }
    ...
    public void PublishManyClassic()
    {
        ...
        try
        {
            ref var data = ref _ringBuffer[sequence - 1];
            data.L1 = 1;
            data.L2 = 2;
            data.L3 = 3;
            data.L4 = 4;
    ...
    public void TryPublishManyClassic()
    {
        ...
        try
        {
            ref var data = ref _ringBuffer[s + 0];
            data.L1 = 1;
            data.L2 = 2;
            data.L3 = 3;
            data.L4 = 4;
