...
public class SequenceBarrierBenchmarksV4 : SequenceBarrierBenchmarks, IDisposable
{
    ...
    public SequenceBarrierBenchmarksV4()
    {
    ...
    private sealed class CustomSequenceBarrier
    {
            ...
            where TSequenceBarrierOptions : ISequenceBarrierOptions
        {
            ...
            if (availableSequence >= sequence)
            {
                ...
                return _multiProducerSequencer.GetHighestPublishedSequence(sequence, availableSequence);
            }
        ...
        private SequenceWaitResult InvokeWaitStrategyAndWaitForPublishedSequence(long sequence)
        {
            ...
            {
                return _multiProducerSequencer.GetHighestPublishedSequence(sequence, waitResult.UnsafeAvailableSequence);
            }
