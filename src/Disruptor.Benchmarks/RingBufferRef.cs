...
namespace Disruptor
{
    ...
    public sealed class RingBufferRef<T> : IEventSequencer<T>, IEventSink<T>, ICursored
        where T : class
    {
        ...
        public RingBufferRef(Func<T> eventFactory, ISequencer sequencer)
        {
        ...
        public RingBufferRef(Func<T> eventFactory, int bufferSize)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetUnsafe(long sequence)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetArray(long sequence)
        {
            return (T)_fields.Entries[RingBufferFields.BufferPad + (int)(sequence & _fields.IndexMask)];
        }
