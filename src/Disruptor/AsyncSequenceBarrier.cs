...
public sealed class AsyncSequenceBarrier
{
    ...
    public AsyncSequenceBarrier(ISequencer sequencer, IWaitStrategy waitStrategy, Sequence cursorSequence, int eventHandlerGroupPosition, Sequence[] dependentSequences)
    {
