...
{
    /// <summary>
    /// Implementations translate (write) data representations into events claimed from the <see cref="ValueRingBuffer{T}"/>.
    ...
    public interface IValueEventTranslator<T>
    {
        /// <summary>
        ...
        void TranslateTo(ref T eventData, long sequence);
    }
}