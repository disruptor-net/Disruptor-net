...
/// </summary>
/// <remarks>
/// The owner can be either an <see cref="IEventHandler"/>, a <see cref="IWorkHandler{T}"/>,
...
public class SequenceWaiterOwner
{
    ...
    /// a <see cref="IWorkHandler{T}"/>, or null if the handler is unknown.
    /// </summary>
    ...
    /// <summary>
    /// Creates a <see cref="SequenceWaiterOwner"/> for a <see cref="IWorkHandler{T}"/>.
    /// </summary>
