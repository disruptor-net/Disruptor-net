    ...
    where T : unmanaged
{
    ...
    /// <summary>
    /// Construct an InterprocessRingBuffer with the full option set.
    /// The <see cref="IpcRingBufferMemory"/> is not owned by the ring buffer and should be disposed after shutdown.
    /// </summary>
